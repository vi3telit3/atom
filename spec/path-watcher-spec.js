...
import {it, fit, beforeEach, afterEach, promisifySome} from './async-spec-helpers'
...
describe('watchPath', function () {
  ...
  describe('watchPath()', function () {
    ...
    fit('reuses an existing native watcher on a parent directory and filters events', async function () {
